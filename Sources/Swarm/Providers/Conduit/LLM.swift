...
/// Opinionated, beginner-friendly inference presets backed by ConduitAdvanced.
///
...
extension LLM {
    ...
    struct AdvancedOptions: Sendable {
        ...
        var baseConfig: ConduitAdvanced.GenerateConfig
        ...
        init(baseConfig: ConduitAdvanced.GenerateConfig, openRouter: OpenRouterOptions = .default) {

...
|---|---|
| Apple Foundation Models | You want on-device inference, OS 27 PCC via `.foundationModels(model:)`, owned-loop `reasoningLevel`, or Swarm profile history seeded onto `Transcript` |

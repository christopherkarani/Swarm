...
The current API reference covers the supported public surface for Swarm 0.6.5. Prefer the front-facing API page for user-facing examples and the API catalog for source-derived symbol lookup.
